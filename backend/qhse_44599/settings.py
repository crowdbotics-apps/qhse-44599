"""
Django settings for qhse_44599 project.
...
WSGI_APPLICATION = 'qhse_44599.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "qhse_44599 API",
    "DESCRIPTION": "API documentation for qhse_44599 App",
    "VERSION": "v1",
}
